...
<template>
  <div class="mt:15vh flex justify-content:center w:100%">
    <div class="w:250 h:400 text:center r:10px b:3|solid|beryl-76 shadow:5|6|teal-68:hover ~300ms|ease-in">
      <h2 class="color:white@dark mt:50">註冊</h2>
      <input v-bind="email" class="mt:50px w:200px h:20px m:10px b:none r:5" type="email" placeholder="電子郵件">
      <input v-bind="username" class="w:200px h:20px m:10px b:none r:5" type="text" placeholder="使用者名稱">
      <input v-bind="password" class="w:200px h:20px m:10px b:none r:5" type="password" placeholder="使用者密碼">
      <button class="w:200px h:20px m:10px b:none r:5 cursor:pointer">確定</button>
      <div class="color:white@dark text:center mt:60">
